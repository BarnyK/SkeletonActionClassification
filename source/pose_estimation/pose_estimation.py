...
#     gen_alphapose_skeletons(
#         "/media/barny/SSD4/MasterThesis/Data/nturgb+d_rgb/",
#         "/media/barny/SSD4/MasterThesis/Data/alphapose_skeletons/ntu_coco/",
#         "coco17",
#     )
#     gen_alphapose_skeletons(
#         "/media/barny/SSD4/MasterThesis/Data/nturgb+d_rgb_120/",
#         "/media/barny/SSD4/MasterThesis/Data/alphapose_skeletons/ntu_120_coco/",
#         "coco17",
#     )
#     gen_alphapose_skeletons(
#         "/media/barny/SSD4/MasterThesis/Data/nturgb+d_rgb/",
#         "/media/barny/SSD4/MasterThesis/Data/alphapose_skeletons/ntu_halpe/",
#         "halpe",
#     )
#     gen_alphapose_skeletons(
#         "/media/barny/SSD4/MasterThesis/Data/nturgb+d_rgb_120/",
#         "/media/barny/SSD4/MasterThesis/Data/alphapose_skeletons/ntu_120_halpe/",
#         "halpe",
#     )

# if __name__ == "__main__2":
#     device = torch.device("cuda:0")
#     gcfg, dcfg, opts = read_configs("coco17", device)
#     folder = "/media/barny/SSD4/MasterThesis/Data/nturgb+d_rgb"
#     filename = os.path.join(folder, "S001C001P001R001A055_rgb.avi")
#     print(filename)
#     detector = init_detector(opts, dcfg)
#     detector.load_model()
#
#     det_loader = DetectionLoader(filename, detector, gcfg, opts, "video", 1, 128)
#     det_loader.start()
#
#     pose = init_pose_model(device, gcfg, gcfg.weights_file)
#
#     x = run_pose_worker(pose, det_loader)
#     # tq = tqdm(range(det_loader.datalen), dynamic_ncols=True)
#     # for i in tq:
#     #     frames = x.get()
#     #     # collect into window
#     #     print(frames)
...
#         # Visualize boxes
#         color = (255, 0, 0)
#         image_with_rectangle = orig_img.copy()
#         for box in range(boxes.size(0)):
#             color = (color[2], color[0], color[1])
#             box = boxes[box]
#             p1 = (int(box[0]), int(box[1]))
#             p2 = (int(box[2]), int(box[3]))
#             orig_img = cv2.rectangle(image_with_rectangle, p1, p2, color, 2)
#
#         color = (125, 125, 0)
#         for box in range(cropped_boxes.size(0)):
#             color = (color[2], color[0], color[1])
#             box = cropped_boxes[box]
#             p1 = (int(box[0]), int(box[1]))
#             p2 = (int(box[2]), int(box[3]))
#             orig_img = cv2.rectangle(image_with_rectangle, p1, p2, color, 2)
