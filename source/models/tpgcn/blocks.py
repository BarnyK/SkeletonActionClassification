...
class Spatial_AAGCN_Block(nn.Module):
    def __init__(self, in_channels, out_channels, max_graph_distance, A, _, coff_embedding=4, adaptive=True,
...
class Spatial_CTRGCN_Block(nn.Module):
    def __init__(self, in_channels, out_channels, max_graph_distance, A, coff_embedding=4, adaptive=True, residual=True,
                 **kwargs):
